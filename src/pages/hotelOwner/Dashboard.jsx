  ...
  return (
    <div>
      <Title
        ...
        font={"Outfit"}
        title={"Dashboard"}
        subTitle="Moniter your room listings, track bookings and analyze revenue—all in one place. Stay updated with real-time insights to ensure smooth operations. "
      />
      ...
      {/* ------------Recent Bookings----------  */}
      <h2 className="text-blue-950/70 font-medium mb-5 text-xl">
        Recent Bookings
      </h2>
